...
sealed class ServerErrors : Exception() {
    ...
    data class UserAlreadyInServer(val id: ServerId, val username: UserId) : ServerErrors()

    data class UserNotInServer(val id: ServerId, val username: UserId) : ServerErrors()
