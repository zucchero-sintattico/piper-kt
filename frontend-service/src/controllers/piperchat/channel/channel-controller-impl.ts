...
export class ChannelControllerImpl
  extends AxiosController
  implements ChannelController
{
  async deleteChannel(
    request: DeleteChannelApi.Request.Type
  ): Promise<DeleteChannelApi.Response> {
  ...
  async getChannels(
    request: GetChannelsApi.Request.Type
  ): Promise<GetChannelsApi.Response> {
    const params = request as GetChannelsApi.Request.Params;
    return await this.get<GetChannelsApi.Response>(
  ...
  async createChannel(
    request: CreateChannelApi.Request.Type
  ): Promise<CreateChannelApi.Response> {
    const params = request as CreateChannelApi.Request.Params;
    const body = request as CreateChannelApi.Request.Body;
    return await this.post<CreateChannelApi.Response>(
      `/servers/${params.serverId}/channels`,
      body
    );
  }
  ...
  async updateChannel(
    request: UpdateChannelApi.Request.Type
  ): Promise<UpdateChannelApi.Response> {
