  ...
  implements UserController
{
  async updateUserPhoto(
    request: UpdatePhotoApi.Request.Type
  ): Promise<UpdatePhotoApi.Response> {
  ...
  async getUserStatus(
    request: GetUserStatusApi.Request.Type
  ): Promise<GetUserStatusApi.Response> {
    const params = request as GetUserStatusApi.Request.Params;
    return await this.get<GetUserStatusApi.Response>(
      `/users/${params.username}/status`
    );
  }

  async getUserPhoto(
    request: GetUserPhotoApi.Request.Type
  ): Promise<GetUserPhotoApi.Response> {
    const params = request as GetUserPhotoApi.Request.Params;
    return await this.get<GetUserPhotoApi.Response>(
      `/users/${params.username}/photo`
    );
  }
  ...
  async getUserDescription(
    ...
    return await this.get<GetUserDescriptionApi.Response>(
      `/users/${params.username}/description`
    );
  }
}
