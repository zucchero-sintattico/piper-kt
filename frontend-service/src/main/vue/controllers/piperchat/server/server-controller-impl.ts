...
export class ServerControllerImpl
  ...
  implements ServerController
{
  ...
  async deleteServer(
    request: DeleteServerApi.Request.Type
  ): Promise<DeleteServerApi.Response> {
    const params = request as DeleteServerApi.Request.Params;
    return await this.delete<DeleteServerApi.Response>(
      `/servers/${params.serverId}`
    );
  }
  ...
  async joinServer(
    request: JoinServerApi.Request.Type
  ...
  async leaveServer(
    request: LeaveServerApi.Request.Type
