...
sealed interface ChannelApi {
    ...
    sealed interface GetChannelMessagesApi : ChannelApi {
        ...
        // Don't need a body for this request
        @Serdeable data class Response(val messages: List<String>) : GetChannelMessagesApi
    }
    ...
    sealed interface SendMessageToChannelApi : ChannelApi {
        ...
        @Serdeable
        data class Response(val channelId: String, val message: String) : SendMessageToChannelApi
    }
}
